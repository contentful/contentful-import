...
export default function runContentfulImport (params) {
  ...
  const tasks = new Listr([
    ...
    },
    {
      ...
      task: wrapTask((ctx) => {
        try {
          const transformedSourceData = transformSpace(ctx.sourceDataUntransformed, ctx.destinationData) //tags, entries, content types are never transformed. I wonder why we need to fetch them in the step above?
