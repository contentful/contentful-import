...
export default function pushToSpace ({
  ...
  return new Listr([
    ...
    },
    {
      ...
      task: wrapTask((ctx, task) => {
        return creation.createEntities(
          { environment: ctx.environment, type: 'Locale' },
          sourceData.locales,
    ...
    },
    {
      ...
      task: wrapTask((ctx, task) => {
        return creation.createEntities(
          {environment: ctx.environment, type: 'ContentType'},
    ...
    },
    {
      ...
      task: wrapTask((ctx, task) => {
        return creation.createEntities(
          {environment: ctx.environment, type: 'Asset'},
          sourceData.assets,
    ...
    },
    {
      ...
      task: wrapTask((ctx, task) => {
        return creation.createEntries(
          {environment: ctx.environment, skipContentModel},
          sourceData.entries,
    ...
    },
    {
      ...
      task: wrapTask((ctx, task) => {
        return creation.createEntities(
          {environment: ctx.environment, type: 'Webhook'},
          sourceData.webhooks,
      ...
      skip: (ctx) => contentModelOnly || environmentId !== 'master'
    }
  ], listrOptions)
}
