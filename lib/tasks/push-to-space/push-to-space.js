      ...
      task: wrapTask((ctx, task) => {
        return creation.createEntities(
          ...
          .then((assetsToProcess) => {
            // TODO: Second parameter. What needs to be passed to
            // processAssets? Does listrOptions actually have timeout and retryLimit params?
            return assets.processAssets(assetsToProcess, listrOptions)
          })
          .then(removeEmptyEntities)
          .then((assets) => {
