...
export default function pushToSpace ({
  ...
  return new Listr([
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const locales = await creation.createLocales({
          ...
          destinationEntities: destinationData.locales,
          requestQueue
        })
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allContentTypes = await creation.createEntities({
          ...
          destinationEntities: destinationData.contentTypes,
          requestQueue
        })
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allTags = await creation.createEntities({
          ...
          destinationEntities: destinationData.tags,
          requestQueue
        })
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allAssets = await creation.createEntities({
          ...
          destinationEntities: destinationData.assets,
          requestQueue
        })
        const assetsToProcess = removeEmptyEntities(allAssets)

        const allProcessedAssets = await assets.processAssets({
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allPublishedAssets = await publishEntities({
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allArchivedAssets = await archiveEntities({
          entities: ctx.data.assets,
          sourceEntities: sourceData.assets,
          requestQueue
        })
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allEntries = await creation.createEntries({
          ...
          destinationEntities: destinationData.entries,
          requestQueue
        })
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allPublishedEntries = await publishEntities({
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allArchivedEntries = await archiveEntities({
          entities: ctx.data.entries,
          sourceEntities: sourceData.entries,
          requestQueue
        })
    ...
    },
    {
      ...
      task: wrapTask(async (ctx, task) => {
        const allWebhooks = await creation.createEntities({
          ...
          destinationEntities: destinationData.webhooks,
          requestQueue
        })
